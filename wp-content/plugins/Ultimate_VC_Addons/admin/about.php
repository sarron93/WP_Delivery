	...
	<div class="wrap-container">
		<div class="heading-section">
			<div class="wrap left-content-section">
				...
				<h2><?php echo __('Geronimo!','ultimate_vc'); ?></h2>
				<p><?php  _e('Ultimate '.ULTIMATE_VERSION.' is installed and you are set to take your website design experience to the next level.','ultimate_vc'); ?></p>
