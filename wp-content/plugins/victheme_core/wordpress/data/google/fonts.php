<?php
/**
 * Main class for the VTCore Wordpress Google
 * Fonts system.
 *
 * This class has internal library for available
 * google fonts settings and its family name.
 *
 * This class is an extension of VTCore_Wordpress_Model_Config
 * class thus all variables are stored in the
 * $options property and it is accessible using
 * the class dot notation function such as get()
 *
 * $options property map :
 * - library = array of available google fonts settings
 * - registered = array of registered fonts that will be
 *                processed when loading the font
 *     - fonts  = array of fonts family
 *     - weight = array of detected font weight
 *     - styles = array of font styles
 *
 * - weightConversion = array of weight conversion from
 *                      css font weight into number weight
 *
 * To use this class example :
 *
 * $font = new VTCore_Wordpress_Data_Google_Fonts();
 * $font->add('registered.fonts.0', 'Open+Sans');
 * $font->add('registered.weight.0', '400');
 * $font->add('registered.styles.0', 'italic');
 *
 * $font->loadFont();
 *
 * Retrieving VTCore_Html_Select() object options
 * This will also valid for VTCore_Wordpress_Form_Fonts() object
 *
 * $options = new VTCore_Wordpress_Data_Google_Fonts();
 * $options->getOptions();
 *
 *
 * Retrieving options valid for wordpress customizer
 *
 * $options = new VTCore_Wordpress_Data_Google_Fonts();
 * $options->getCustomizerOptions();
 *
 * @todo Implement transient system plus database saving
 * @todo Implement auto updating methods
 * @author jason.xie@victheme.com
 *
 */
class VTCore_Wordpress_Data_Google_Fonts
extends VTCore_Wordpress_Models_Config {
  ...
  private $json = '
  {
   ...
   "items": [
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "regular": "http://fonts.gstatic.com/s/inconsolata/v9/7bMKuoy6Nh0ft0SHnIGMuaCWcynf_cDxXwCLxiixG1c.ttf",
      "700": "http://fonts.gstatic.com/s/inconsolata/v9/AIed271kqQlcIRSOnQH0yXe1Pd76Vl7zRpE7NLJQ7XU.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "100": "http://fonts.gstatic.com/s/josefinsans/v8/q9w3H4aeBxj0hZ8Osfi3d8SVQ0giZ-l_NELu3lgGyYw.ttf",
      "100italic": "http://fonts.gstatic.com/s/josefinsans/v8/s7-P1gqRNRNn-YWdOYnAOXXcj1rQwlNLIS625o-SrL0.ttf",
      "300": "http://fonts.gstatic.com/s/josefinsans/v8/C6HYlRF50SGJq1XyXj04z6cQoVhARpoaILP7amxE_8g.ttf",
      "300italic": "http://fonts.gstatic.com/s/josefinsans/v8/ppse0J9fKSaoxCIIJb33Gyna0FLWfcB-J_SAYmcAXaI.ttf",
      "regular": "http://fonts.gstatic.com/s/josefinsans/v8/xgzbb53t8j-Mo-vYa23n5i3USBnSvpkopQaUR-2r7iU.ttf",
      "italic": "http://fonts.gstatic.com/s/josefinsans/v8/q9w3H4aeBxj0hZ8Osfi3d_MZXuCXbOrAvx5R0IT5Oyo.ttf",
      "600": "http://fonts.gstatic.com/s/josefinsans/v8/C6HYlRF50SGJq1XyXj04z2v8CylhIUtwUiYO7Z2wXbE.ttf",
      "600italic": "http://fonts.gstatic.com/s/josefinsans/v8/ppse0J9fKSaoxCIIJb33G4R-5-urNOGAobhAyctHvW8.ttf",
      "700": "http://fonts.gstatic.com/s/josefinsans/v8/C6HYlRF50SGJq1XyXj04z0D2ttfZwueP-QU272T9-k4.ttf",
      "700italic": "http://fonts.gstatic.com/s/josefinsans/v8/ppse0J9fKSaoxCIIJb33G_As9-1nE9qOqhChW0m4nDE.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "100": "http://fonts.gstatic.com/s/lato/v10/Upp-ka9rLQmHYCsFgwL-eg.ttf",
      "100italic": "http://fonts.gstatic.com/s/lato/v10/zLegi10uS_9-fnUDISl0KA.ttf",
      "300": "http://fonts.gstatic.com/s/lato/v10/Ja02qOppOVq9jeRjWekbHg.ttf",
      "300italic": "http://fonts.gstatic.com/s/lato/v10/dVebFcn7EV7wAKwgYestUg.ttf",
      "regular": "http://fonts.gstatic.com/s/lato/v10/h7rISIcQapZBpei-sXwIwg.ttf",
      "italic": "http://fonts.gstatic.com/s/lato/v10/P_dJOFJylV3A870UIOtr0w.ttf",
      "700": "http://fonts.gstatic.com/s/lato/v10/iX_QxBBZLhNj5JHlTzHQzg.ttf",
      "700italic": "http://fonts.gstatic.com/s/lato/v10/WFcZakHrrCKeUJxHA4T_gw.ttf",
      "900": "http://fonts.gstatic.com/s/lato/v10/8TPEV6NbYWZlNsXjbYVv7w.ttf",
      "900italic": "http://fonts.gstatic.com/s/lato/v10/draWperrI7n2xi35Cl08fA.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "regular": "http://fonts.gstatic.com/s/lora/v8/aXJ7KVIGcejEy1abawZazg.ttf",
      "italic": "http://fonts.gstatic.com/s/lora/v8/AN2EZaj2tFRpyveuNn9BOg.ttf",
      "700": "http://fonts.gstatic.com/s/lora/v8/enKND5SfzQKkggBA_VnT1A.ttf",
      "700italic": "http://fonts.gstatic.com/s/lora/v8/ivs9j3kYU65pR9QD9YFdzQ.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "regular": "http://fonts.gstatic.com/s/montserrat/v5/Kqy6-utIpx_30Xzecmeo8_esZW2xOQ-xsNqO47m55DA.ttf",
      "700": "http://fonts.gstatic.com/s/montserrat/v5/IQHow_FEYlDC4Gzy_m8fcgJKKGfqHaYFsRG-T3ceEVo.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "300": "http://fonts.gstatic.com/s/oswald/v9/y3tZpCdiRD4oNRRYFcAR5Q.ttf",
      "regular": "http://fonts.gstatic.com/s/oswald/v9/uLEd2g2vJglLPfsBF91DCg.ttf",
      "700": "http://fonts.gstatic.com/s/oswald/v9/7wj8ldV_5Ti37rHa0m1DDw.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "300": "http://fonts.gstatic.com/s/oxygen/v4/lZ31r0bR1Bzt_DfGZu1S8A.ttf",
      "regular": "http://fonts.gstatic.com/s/oxygen/v4/uhoyAE7XlQL22abzQieHjw.ttf",
      "700": "http://fonts.gstatic.com/s/oxygen/v4/yLqkmDwuNtt5pSqsJmhyrg.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "regular": "http://fonts.gstatic.com/s/ptsans/v7/UFoEz2uiuMypUGZL1NKoeg.ttf",
      "italic": "http://fonts.gstatic.com/s/ptsans/v7/yls9EYWOd496wiu7qzfgNg.ttf",
      "700": "http://fonts.gstatic.com/s/ptsans/v7/F51BEgHuR0tYHxF0bD4vwvesZW2xOQ-xsNqO47m55DA.ttf",
      "700italic": "http://fonts.gstatic.com/s/ptsans/v7/lILlYDvubYemzYzN7GbLkC3USBnSvpkopQaUR-2r7iU.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
    ...
    },
    {
     ...
     "lastModified": "2014-08-28",
     "files": {
      "100": "http://fonts.gstatic.com/s/roboto/v13/7MygqTe2zs9YkP0adA9QQQ.ttf",
      "100italic": "http://fonts.gstatic.com/s/roboto/v13/T1xnudodhcgwXCmZQ490TPesZW2xOQ-xsNqO47m55DA.ttf",
      "300": "http://fonts.gstatic.com/s/roboto/v13/dtpHsbgPEm2lVWciJZ0P-A.ttf",
      "300italic": "http://fonts.gstatic.com/s/roboto/v13/iE8HhaRzdhPxC93dOdA056CWcynf_cDxXwCLxiixG1c.ttf",
      "regular": "http://fonts.gstatic.com/s/roboto/v13/W5F8_SL0XFawnjxHGsZjJA.ttf",
      "italic": "http://fonts.gstatic.com/s/roboto/v13/hcKoSgxdnKlbH5dlTwKbow.ttf",
      "500": "http://fonts.gstatic.com/s/roboto/v13/Uxzkqj-MIMWle-XP2pDNAA.ttf",
      "500italic": "http://fonts.gstatic.com/s/roboto/v13/daIfzbEw-lbjMyv4rMUUTqCWcynf_cDxXwCLxiixG1c.ttf",
      "700": "http://fonts.gstatic.com/s/roboto/v13/bdHGHleUa-ndQCOrdpfxfw.ttf",
      "700italic": "http://fonts.gstatic.com/s/roboto/v13/owYYXKukxFDFjr0ZO8NXh6CWcynf_cDxXwCLxiixG1c.ttf",
      "900": "http://fonts.gstatic.com/s/roboto/v13/H1vB34nOKWXqzKotq25pcg.ttf",
      "900italic": "http://fonts.gstatic.com/s/roboto/v13/b9PWBSMHrT2zM5FgUdtu0aCWcynf_cDxXwCLxiixG1c.ttf"
     }
    },
    {
     "kind": "webfonts#webfont",
  ...
  protected function register(array $options) {
    ...
    foreach ($parsed->items as $item) {
      $this->options['library'][str_replace(' ', '+', $item->family)] = $item;
    }

    $this->options['weightConversion'] = array(
      'thin' => 100,
      'extra-light' => 200,
      'light' => 300,
      'normal' => 400,
    ...
    $this->filter = 'vtcore_google_font_library_alter';
  ...
  /**
   * Method for building valid HTML select options
   */
  public function getOptions() {
    $options = array();
    foreach ($this->options['library'] as $family => $item) {
      $options[$family] = array(
        'text' => str_replace('+', ' ', $family),
        'attributes' => array(
          'value' => $family,
        ),
        'data' => array(
  ...
  /**
   * Method for building valid customizer
   * select html options.
   */
  public function getCustomizerOptions() {
    $options = array();
    foreach ($this->options['library'] as $family => $item) {
      $options[$family] = $item->family;
    }
  ...
  /**
   * Method for generating valid google fonts
   * query strings.
   *
   * @return string
   */
  public function buildFontString() {
    ...
    // Crafting the variants as google
    // needs {weight}{style} merged
    // as single string entry
    if ($this->get('registered.weight')) {
      foreach ($this->get('registered.weight') as $weight) {

        if (!is_numeric($weight)
            && $this->get('weightConversion.' . $weight)) {
          $weight = $this->get('weightConversion.' . $weight);
        }

        $variant[] = $weight;
        foreach ($this->get('registered.styles') as $style) {
          $variant[] = $weight . $style;
        }
      }
    }

    // Crafting the fonts array and match
    // the fonts against valid google font
    // json API
    if ($this->get('registered.fonts')) {
      foreach ($this->get('registered.fonts') as $delta => $font) {

        // Get the stored json for this font
        $item = $this->get('library.' . $font);
        $match = array();

        // Building the correct variant
        foreach ($variant as $size) {
          foreach ($item->variants as $google_variant) {
            if ($google_variant == 'regular') {
              $google_variant = 400;
            }

            if ($google_variant == $size) {
              $match[$size] = $size;
            }
          }
        }

        // Registering current font available
        // subsets
        foreach ($item->subsets as $subset) {
          $subsets[$subset] = $subset;
        }

        // Crafting the font url string
        $fonts[$delta] = $font;

        if (!empty($match)) {
          $fonts[$delta] .= ':' . implode(':', $match);
        }
      }
    }
    ...
    // Mergin strings
    if (!empty($fonts)) {
      $string = 'http://fonts.googleapis.com/css?family=' . implode('|', $fonts);
    }
  ...
  /**
   * Method for registering the crafted google
   * fonts url to wordpress styles registry.
   *
   * @param string $reset
   */
  public function loadFont($reset = false) {
    if ($reset) {
      $this->remove(array('url'));
    }
    ...
    if ($this->get('url')) {
      wp_enqueue_style('vtcore-google-fonts', $this->get('url'), false, null, 'all');
    }
  }
}