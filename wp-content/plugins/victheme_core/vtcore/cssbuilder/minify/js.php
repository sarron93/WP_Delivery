 ...
 * JS Minifier
 *
 * Usage - VTCore_CSSBuilder_Minify_Js::minify($js);
 * Usage - VTCore_CSSBuilder_Minify_Js::minify($js, $options);
 * Usage - VTCore_CSSBuilder_Minify_Js::minify($js, array('flaggedComments' => false));
 *
 * Modified to play nice with VTCore
 *
 * @package JShrink
 * @author Robert Hafner <tedivm@tedivm.com>
 * @license http://www.opensource.org/licenses/bsd-license.php  BSD License
 */
class VTCore_CSSBuilder_Minify_JS
{
    /**
    ...
    public static function minify($js, $options = array())
    {
        try {
            ...
            $jshrink = new VTCore_CSSBuilder_Minify_JS();
            $js = $jshrink->lock($js);
