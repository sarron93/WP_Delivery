<?php
	...
	Description: Shared on <a href="http://themelord.com" style="color:red">Themelord.com</a> Premium WordPress form and survey builder. Make amazing forms, incredibly fast.
	Author: nCrafts
	...
	*/
	...
	$fc_files_table = $wpdb->prefix . "formcraft_3_files";
		$response['purchased'] = date(get_option('date_format'), strtotime("now"));
		$response['expires'] = date(get_option('date_format'), strtotime("+1 years"));
		$response['registered'] = date(get_option('date_format'), strtotime("now"));
		...
		update_site_option( 'f3_key', "d7d2cf2f-a2bf-0bd7-f8cf-0095189d2861" );
		update_site_option( 'f3_blog_id', get_current_blog_id() );
		update_site_option( 'f3_email', "nulled@example.com" );
