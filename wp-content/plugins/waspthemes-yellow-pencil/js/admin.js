! function(t) {
    ...
    t(document).ready(function() {
        ...
        }), 0 == t("body").hasClass("post-type-attachment") && t("#postbox-container-1").length > 0 && (t("#postbox-container-1").prepend("<a class='yp-btn-bottom'>OR <small>CUSTOMIZE " + typenow + " TEMPLATE</small></a>"), t("#postbox-container-1").prepend("<a class='yp-btn'><small>Edit page -</small> Yellow Pencil</a>"))
    })
}(jQuery);