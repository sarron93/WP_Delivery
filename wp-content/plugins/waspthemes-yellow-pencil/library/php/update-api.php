...
// User information
define("YP_USERNAME",get_option('username'));
define("YP_APIKEY",get_option('apikey'));
define("YP_PURCHASE_CODE",get_option('purchase_code'));
...
function yp_update_message(){
    ...
    if($isUpdate == 'true' && $lastCheckVer == YP_PLUGIN_VERSION && $available > YP_PLUGIN_VERSION && current_user_can("update_plugins") == true && YP_USERNAME != '' && YP_APIKEY != '' && YP_PURCHASE_CODE != ''){
        ...
        <div class="updated yp-update-info-bar">
            <p>New version is avaliable for Yellow Pencil. Please update plugin for new features and improvements. <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="#" class="yp_update_link">Update Now!</a></p>
        </div>
        <?php
        ...
        ?>
        <div class="updated yp-update-info-bar">
            <p>New version is avaliable for Yellow Pencil but you need enter some informations for update. <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="<?php echo admin_url('options-general.php?page=yp-update-settings'); ?>">Lets go</a></p>
        </div>
        <?php
    ...
    jQuery(document).ready(function($) {
        ...
        jQuery(".yp_update_link").click(function(){
            ...
            if(!jQuery(this).hasClass("yp_update_link_disable")){
                ...
                jQuery(this).append("<img src='/wp-admin/images/wpspin_light.gif' style='position: relative;left: 7px;top: 2px;width: 12px;height: 12px;' />");
...
function yp_create_setting_menu() {
    ...
    if(defined('WTFV')){
        ...
        add_submenu_page( 'options-general.php', 'Yellow Pencil Update', 'Yellow Pencil Update', 'edit_theme_options', 'yp-update-settings', 'yp_settings' );
...
function yp_register_settings(){
    register_setting( 'yp-update-settings', 'username' );
    register_setting( 'yp-update-settings', 'apikey' );
    register_setting( 'yp-update-settings', 'purchase_code' );
}
...
function yp_settings(){ ?>
    ...
    <p>please set all settings for update plugin automatic, for the best experience please update plugin always.<br />Don't worry, You will not lose your changes after updates.</p>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
            <th scope="row">Codecanyon Username</th>
            <td><input type="text" name="username" value="<?php echo esc_attr( get_option('username') ); ?>" />
            <p style="font-weight:400;font-style:italic;font-size:90%;">Your codecanyon username.</p>
            </td>
            </tr>
             
            <tr valign="top">
            <th scope="row">Codecanyon Api Key</th>
            <td><input type="text" name="apikey" value="<?php echo esc_attr( get_option('apikey') ); ?>" />
            <p><a target="_blank" style="font-weight:400;font-style:italic;font-size:90%;text-decoration:none;" href="https://help.market.envato.com/hc/en-us/articles/204498284-API-Keys">Where is my api key?</a></p>
            </td>
            </tr>
            
            <tr valign="top">
            <th scope="row">Plugin Purchase Key:</th>
            <td><input type="text" name="purchase_code" value="<?php echo esc_attr( get_option('purchase_code') ); ?>" />
            <p><a target="_blank" style="font-weight:400;font-style:italic;font-size:90%;text-decoration:none;" href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Can-I-Find-my-Purchase-Code-">Where is purchase key?</a></p>
            </td>
            </tr>
        </table>
        <?php submit_button(); ?>
