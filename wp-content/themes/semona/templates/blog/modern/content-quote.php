...
?>
<article id="post-<?php the_ID(); ?>" <?php echo post_class( array('sm-post sm-post-quote sm-isotope-item') ) ?>>
	...
	<?php get_template_part( 'templates/blog/modern/content', 'body-quote' ) ?>
</article>