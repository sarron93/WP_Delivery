...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Standard Fonts', 'semona' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'semona' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => esc_html__( 'All', 'semona' ),
		'cyrillic'     => esc_html__( 'Cyrillic', 'semona' ),
		'cyrillic-ext' => esc_html__( 'Cyrillic Extended', 'semona' ),
		'devanagari'   => esc_html__( 'Devanagari', 'semona' ),
		'greek'        => esc_html__( 'Greek', 'semona' ),
		'greek-ext'    => esc_html__( 'Greek Extended', 'semona' ),
		'khmer'        => esc_html__( 'Khmer', 'semona' ),
		'latin'        => esc_html__( 'Latin', 'semona' ),
		'latin-ext'    => esc_html__( 'Latin Extended', 'semona' ),
		'vietnamese'   => esc_html__( 'Vietnamese', 'semona' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'semona' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'semona' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'semona' ),
			'stack' => 'Monaco,"Lucida Sans Typewriter","Lucida Typewriter","Courier New",Courier,monospace'
		),
		'georgia' => array(
			'label' => _x( 'Georgia', 'font style', 'semona' ),
			'stack' => 'Georgia, Times, "Times New Roman", serif'
		)
	);
}
